...
namespace PostgreConsoleInteractorCS {
    public class DatabaseModel {
        ...
        public void Search() {
            ...
            Console.WriteLine("1 - select goods by trademark_id");
            Console.WriteLine("2 - select goods by categoty_id");
            Console.WriteLine("3 - select name by trademark_id");
            Console.Write("Your choice - ");
            int search = int.Parse(Console.ReadLine());
            switch (search) {
                case 1:
                    Console.Write("Input trademark_id - ");
                    string trademark_id = Console.ReadLine();
                    NpgsqlCommand command1 = new NpgsqlCommand("SELECT name FROM category WHERE department_id = " + trademark_id, connection);
                ...
                case 2:
                    ...
                    NpgsqlCommand command2 = new NpgsqlCommand("SELECT name FROM goods WHERE category_id = " + category_id, connection);
                ...
                case 3:
                    Console.Write("Input trademark_id - ");
                    string trademark_id3 = Console.ReadLine();
                    NpgsqlCommand command3 = new NpgsqlCommand("SELECT name FROM department WHERE department_id = " + trademark_id3, connection);
